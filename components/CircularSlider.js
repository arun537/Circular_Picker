/*
*  gitURL: https://github.com/bartgryszko/react-native-circular-slider.git
*/
...
import CircularFace from './CircularFace';
...
export default class CircularSlider extends PureComponent {
  ...
  render() {
    ...
    return (
      <View style={{ width: containerWidth+40, height: containerWidth+40,  justifyContent:'center', alignItems:'center', alignSelf:'center'}} onLayout={this.onLayout}>
        <Svg
        ...
        >
          ...
          */}
          ...
          <G transform={{ translate: `${strokeWidth/2 + radius + 10 +1}, ${strokeWidth/2 + radius +10+ 1}` }}>
          <Circle
              r={radius+6}
              strokeWidth={2}
              fill="transparent"
